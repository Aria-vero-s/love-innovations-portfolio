function createBespokeProjects() {
    const projects = [
        {
            id: "piano-chest-featured",
            ...
            image: "./images/03_furniture/project/thumbnail.png",
            date: "2024",
        ...
        },
        {
            ...
            description: "Handcrafted dining table from reclaimed ship timber with steel accents and custom joinery.",
        ...
        },
        {
            ...
            description: "Floor-to-ceiling wardrobe system with custom compartments and integrated lighting.",
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-xl text-muted-foreground mt-4">
                                    Handcrafted furniture and storage solutions designed for lifetime durability
                                </p>
                            </div>
                        </div>
                    </div>
...
window.createBespokeProjects = createBespokeProjects;